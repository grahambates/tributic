...
zx0_decompress:
        ...
        ; moveq.l #-1,d6  ; initialize rep-offset to 1
        bra.s   .literals
...
.do_copy_offs:
        ...
        add.l   d6,a2   ; (dest + negative match offset)
.copy_match:
...
.got_elias3:
        ...
        move.w  (sp)+,d6 ; shift it to make room for low byte

        move.b  (a0)+,d6 ; read low byte of offset + 1 bit of len
        asr.l   #1,d6   ; shift len bit into carry/offset in place
